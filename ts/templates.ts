         ...
         <div name="${renderGeneration}-show-pokemon-card" id="${renderId}" onclick="showBigPokemonCard(${renderId})"
                  ...
                  <div name="pokemon-name"
                     ...
                     <div name="name-text" class="font-normal text-xxs flex items-center text-center">${
                        renderName[0].toUpperCase() + renderName.slice(1)
                     }</div>
                  </div>
               </div>
         `;
...
function createSortBtn(i: number) {
   return `
...
function createSortIdBtn(i: number) {
   return `
...
function renderBigPokemonCardWithStats(renderBigPokemonCard: PokemonCard) {
   return `
         ...
         <div id="pokecard" name="card-pokemon" class="w-90 h-640 relative border-r-075rem" style="background-color:${
            ...
            <div name="pokemon-card-name-header"
               ...
               <div name="pokemon-name" class="w-56 h-8 font-bold text-2xl flex items-center justify-center text-white">${
                  renderBigPokemonCard.pokemonName
               }</div>
            ...
            <div name="current-pokemon-stats-card"
               ...
               <div name="pokemon-type" class="flex justify-center p-0 gap-4 w-78 h-5">
                  <div name="type1" id="pokemonType1" class="w-14 h-5 py-05 px-2 flex flex-col bg-color-type-psychic rounded-lg" style="background-color:${
                     renderBigPokemonCard.color
                  }">
                     <div class="w-10 h-4 text-xs text-white flex items-center justify-center">${
                        renderBigPokemonCard.pokemonType1
                     }</div>
                  </div>
                  <div name="type2" id="pokemonType2" class="w-14 h-5 py-05 px-2 flex flex-col bg-color-type-medium-gray rounded-lg" style="background-color:${
                     renderBigPokemonCard.pokemonColor2
                  }">
                     <div class=" w-10 h-4 text-xs text-white flex items-center justify-center">${
                        renderBigPokemonCard.pokemonType2
                     }
                     </div>
                  </div>
               </div>
               ...
               <div name="title-about" class="flex justify-center p-0 w-78 h-4">
                  <div name="title-about-text"
                     class="text-sm font-bold flex items-center justify-center text-center w-78 h-4 text-color-type-psychic" style="color:${
                        renderBigPokemonCard.color
                     }">
                     About</div>
               </div>
               ...
               <div name="about-current-pokemon-stats" class="flex p-0 justify-between w-64 h-12">
                  <div name="weight" class="flex flex-col p-0 w-13 h-12">
                     <div name="value-weight" class="flex py-2 gap-2 w-13 h-9">
                        ...
                        <div class="text-xxs font-normal w-8 h-4 text-color-type-dark-gray">${
                           renderBigPokemonCard.pokemonWeight
                        }kg</div>
                     </div>
                  ...
                  <div name="height" class="flex flex-col p-0 w-13 h-12">
                     <div name="value-height" class="flex py-2 gap-2 w-13 h-9">
                        ...
                        <div class="text-xxs font-normal w-8 h-4 text-color-type-dark-gray">${
                           renderBigPokemonCard.pokemonHeight
                        } m</div>
                     </div>
                     <div class="flex justify-center">
                  ...
                  <div name="abilities" class="flex flex-col p-0 w-13 h-12">
                     ...
                     <div class="flex justify-center">
                        <div class="text-xxs font-normal w-8 h-4 text-color-type-dark-gray text-center">${
                           renderBigPokemonCard.pokemonAbilitie1
                        }</div>
                     </div>
                  </div>
               </div>
               ...
               <div name="text-over-pokemon"
                  class="flex items-center w-78 h-8 text-center font-normal text-xxs text-color-type-dark-gray">${
                     renderBigPokemonCard.flavorPokemon
                  }</div>
               <div name="title-stats"
                  class="font-bold text-sm w-78 h-4 flex items-center justify-center text-color-type-psychic" style="color:${
                     renderBigPokemonCard.color
                  }">Base Stats
               </div>
               <!-- base stats -->
               <div name="base-stats-current-pokemon" class="flex p-0 gap-2 w-78 h-25">
                  <div name="base-stats-name" class="flex flex-col p-0 w-7 h-25">
                     <div name="HP" class="font-bold text-xxs flex items-center justify-end text-color-type-psychic" style="color:${
                        renderBigPokemonCard.color
                     }">HP
                     </div>
                     <div name="ATK" class="font-bold text-xxs flex items-center justify-end text-color-type-psychic" style="color:${
                        renderBigPokemonCard.color
                     }">
                        ATK
                     </div>
                     <div name="DEF" class="font-bold text-xxs flex items-center justify-end text-color-type-psychic" style="color:${
                        renderBigPokemonCard.color
                     }">
                        DEF
                     </div>
                     <div name="SATK" class="font-bold text-xxs flex items-center justify-end text-color-type-psychic" style="color:${
                        renderBigPokemonCard.color
                     }">
                        SATK
                     </div>
                     <div name="SDEF" class="font-bold text-xxs flex items-center justify-end text-color-type-psychic" style="color:${
                        renderBigPokemonCard.color
                     }">
                        SDEF
                     </div>
                     <div name="SPD" class="font-bold text-xxs flex items-center justify-end text-color-type-psychic" style="color:${
                        renderBigPokemonCard.color
                     }">
                        SPD
                     </div>
                  ...
                  <div name="base-stats-level" class="flex flex-col w-5 h-25">
                     <div name="base-stats-level"
                        class="w-5 h-4 font-normal text-xxs flex items-center text-color-type-dark-gray">${
                           renderBigPokemonCard.pokemonHP
                        }</div>
                     <div name="base-stats-level"
                        class="w-5 h-4 font-normal text-xxs flex items-center text-color-type-dark-gray">${
                           renderBigPokemonCard.pokemonAtk
                        }</div>
                     <div name="base-stats-level"
                        class="w-5 h-4 font-normal text-xxs flex items-center text-color-type-dark-gray">${
                           renderBigPokemonCard.pokemonDef
                        }</div>
                     <div name="base-stats-level"
                        class="w-5 h-4 font-normal text-xxs flex items-center text-color-type-dark-gray">${
                           renderBigPokemonCard.pokemonSatk
                        }</div>
                     <div name="base-stats-level"
                        class="w-5 h-4 font-normal text-xxs flex items-center text-color-type-dark-gray">${
                           renderBigPokemonCard.pokemonSdef
                        }</div>
                     <div name="base-stats-level"
                        class="w-5 h-4 font-normal text-xxs flex items-center text-color-type-dark-gray">${
                           renderBigPokemonCard.pokemonSpd
                        }</div>
                  </div>
                  <div class="w-full h-25 flex flex-col">
                     <div name="loader" class="loader relative h-2 w-full m-1">
                        ...
                        <div name="loading_2" class="loading_HP absolute h-full bg-color-type-psychic top-0" style="background-color: ${
                           renderBigPokemonCard.color
                        }">
                           <style type="text/css">
                              .loading_HP {
                     ...
                     <div name="loader" class="loader relative h-2 w-full m-1">
                        <div name="loading_1" class="loading_1 relative w-full h-full bg-color-type-light-gray"></div>
                        <div name="loading_2" class="loading_ATK absolute h-full bg-color-type-psychic top-0" style="background-color: ${
                           renderBigPokemonCard.color
                        }">
                           <style type="text/css">
                              .loading_ATK {
                     ...
                     <div name="loader" class="loader relative h-2 w-full m-1">
                        <div name="loading_1" class="loading_1 relative w-full h-full bg-color-type-light-gray"></div>
                        <div name="loading_2" class="loading_DEF absolute h-full bg-color-type-psychic top-0" style="background-color: ${
                           renderBigPokemonCard.color
                        }">
                           <style type="text/css">
                              .loading_DEF {
                     ...
                     <div name="loader" class="loader relative h-2 w-full m-1">
                        <div name="loading_1" class="loading_1 relative w-full h-full bg-color-type-light-gray"></div>
                        <div name="loading_2" class="loading_SATK absolute h-full bg-color-type-psychic top-0" style="background-color: ${
                           renderBigPokemonCard.color
                        }">
                           <style type="text/css">
                              .loading_SATK {
                     ...
                     <div name="loader" class="loader relative h-2 w-full m-1">
                        <div name="loading_1" class="loading_1 relative w-full h-full bg-color-type-light-gray"></div>
                        <div name="loading_2" class="loading_SDEF absolute h-full bg-color-type-psychic top-0" style="background-color: ${
                           renderBigPokemonCard.color
                        }">
                           <style type="text/css">
                              .loading_SDEF {
                     ...
                     <div name="loader" class="loader relative h-2 w-full m-1">
                        <div name="loading_1" class="loading_1 relative w-full h-full bg-color-type-light-gray"></div>
                        <div name="loading_2" class="loading_SPD absolute h-full bg-color-type-psychic top-0" style="background-color: ${
                           renderBigPokemonCard.color
                        }">
                           <style type="text/css">
                              .loading_SPD {
...
<div class="w-full flex justify-center items-center mb-4">
   <div name="closeBtn" class="px-4 border border-solid rounded-md hover:bg-gray-200 cursor-pointer" onclick="closeBigCard()">Close</div>
            ...
            <div class="absolute top-48 left-7 cursor-pointer" id="arrow-small-left" onclick="showBigPokemonCard(${
            ...
            <div class="absolute top-48 right-7 cursor-pointer z-10" id="arrow-small-right" onclick="showBigPokemonCard(${
               renderBigPokemonCard.pokemonId + 1
            })">
