...
async function showBigPokemonCard(idPokemon) {
    ...
    //fix format bug:
    let flavorOld = url2responseCurrentPokemonAsJson["flavor_text_entries"][0]["flavor_text"];
    let flavorNewFixed = flavorOld.replace("\f", " ");
    let color = setColorCodeCurrentPokemon(url1responseCurrentPokemonAsJson, 0);
    let renderBigPokemonCard = new PokemonCard(url2responseCurrentPokemonAsJson["id"], url2responseCurrentPokemonAsJson["name"][0].toUpperCase() +
        url2responseCurrentPokemonAsJson["name"].slice(), url1responseCurrentPokemonAsJson["sprites"]["other"]["official-artwork"]["front_default"], url1responseCurrentPokemonAsJson["types"][0]["type"]["name"][0].toUpperCase() +
        url1responseCurrentPokemonAsJson["types"][0]["type"]["name"].slice(1), color, url2responseCurrentPokemonAsJson["generation"]["name"], url1responseCurrentPokemonAsJson["weight"] / 10, url1responseCurrentPokemonAsJson["height"] / 10, url1responseCurrentPokemonAsJson["abilities"][0]["ability"]["name"][0].toUpperCase() +
        url1responseCurrentPokemonAsJson["abilities"][0]["ability"]["name"].slice(1), flavorNewFixed, url1responseCurrentPokemonAsJson["stats"][0]["base_stat"], url1responseCurrentPokemonAsJson["stats"][1]["base_stat"], url1responseCurrentPokemonAsJson["stats"][2]["base_stat"], url1responseCurrentPokemonAsJson["stats"][3]["base_stat"], url1responseCurrentPokemonAsJson["stats"][4]["base_stat"], url1responseCurrentPokemonAsJson["stats"][5]["base_stat"], type2, abilities2, color2);
