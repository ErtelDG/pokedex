...
function renderSmallPokemonCard(i) {
    ...
    if (containerRenderAllPokemonSmall != null) {
        for (let j = 1; j <= Object.keys(generationSelected).length; j++) {
            ...
            let renderName = generationSelected[generationKeyPosition]["pokemonName"];
            let renderImage = generationSelected[generationKeyPosition]["pokemonImage"];
            let renderColor = generationSelected[generationKeyPosition]["color"];
            let renderGeneration = generationSelected[generationKeyPosition]["pokemonGeneration"];
